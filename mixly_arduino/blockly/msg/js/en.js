...
Blockly.blynk_IOT_FAN_1='slow'; 
Blockly.blynk_IOT_FAN_2='middle';
Blockly.blynk_IOT_FAN_3='fast';
...
Blockly.blynk_IOT_IR_FAN='Fan Speed';
Blockly.blynk_IOT_IR_POWER='Power';
Blockly.blynk_IOT_IR_RECEIVE_RAW='IR Receive Pin';
Blockly.blynk_IOT_IR_SEND='IR Send Pin';
Blockly.blynk_IOT_IR_SEND_CODE='code';
...
Blockly.blynk_USB_SERVER_INFO='USB Mode';
...
Blockly.IICSCAN='IIC Address Finder';
...
Blockly.MIXLY_ESP32_IOT_WIFI_CONNECT_TOOLTIP= "connect to Wi-Fi with name and password of";
...
Blockly.MIXLY_ESP32_NETWORK_CONNECT_TOOLTIP='Set the Wi-Fi name and password';
Blockly.MIXLY_ESP32_NETWORK_GATEWAY='Gateway';
Blockly.MIXLY_ESP32_NETWORK_GET_CONNECT_TOOLTIP='Return the address of the connected Wi-Fi';
Blockly.MIXLY_ESP32_NETWORK_GET_WIFI='Get Wi-Fi';
Blockly.MIXLY_ESP32_NETWORK_GET_WIFI_TOOLTIP='Return the connection name of Wi-Fi';
Blockly.MIXLY_ESP32_NETWORK_INIT_TOOLTIP='Set Wi-Fi working mode and initialize Wi-Fi';
...
Blockly.MIXLY_ESP32_NETWORK_SCAN_TOOLTIP='Return the connectable Wi-Fi address';
...
Blockly.MIXLY_ESP32_NETWORK_WIFI_CONNECT_TOOLTIP='Return true when connected to Wi-Fi';
...
Blockly.MIXLY_HARDWARE_START='Hardware Interact Start';
...
Blockly.MIXLY_MIXPY_TURTLE_WIDTH= 'pen size';
...
Blockly.MIXLY_TOOLTIP_I2C_HOWMANY = 'Return howMany of I2C slave onReceive';
Blockly.MIXLY_TOOLTIP_I2C_SLAVE_ONREQUEST = 'I2C slave onRequest';
Blockly.MIXLY_TOOLTIP_I2C_SLAVE_WRITE = 'I2C write a byte for slave device';
Blockly.MIXLY_TOOLTIP_I2C_SLAVE_WRITE_ARRAY = 'I2C write array for slave device';
...
Blockly.OLED_BITMAP_DATA='Bitmap Data';
Blockly.OLED_BITMAP_NAME='Bitmap Name';
...
Blockly.OLED_DEF_BMP_DATA_TOOLTIP='';
Blockly.OLED_DRAW_CIRCLE= 'Draw Circle';
Blockly.OLED_DRAW_ELLIPSE= 'Draw Ellipse';
Blockly.OLED_DRAW_ELLIPSE_TOOLTIP='';
Blockly.OLED_DRAW_LINE_TOOLTIP='';
Blockly.OLED_DRAW_PIXE_TOOLTIP='';
...
Blockly.OLED_DRAWPIXEL= 'Draw Pixel';
...
Blockly.OLED_FONT_chinese1= 'Song 1(411)';
Blockly.OLED_FONT_chinese2= 'Song 2(574)';
Blockly.OLED_FONT_chinese3= 'Song 3(993)';
Blockly.OLED_FONT_gb2312= 'Song (7539)';
Blockly.OLED_FONT_gb2312a= 'Song A(4041)';
Blockly.OLED_FONT_gb2312b= 'Song B(4531)';
Blockly.OLED_GET_HEIGHT_TOOLTIP='';
Blockly.OLED_HOLLOW='Hollow';
Blockly.OLED_HOR= 'Horizontal';
Blockly.OLED_ICON='Icon';
Blockly.OLED_INIT2='OLED Initialize(I2C)';
Blockly.OLED_INIT2_TOOLTIP='';
...
Blockly.ESP32_SENSOR_NIXGO_LIGHT_TOOLTIP= ''
Blockly.ESP32_SENSOR_NIXGO_SOUND_TOOLTIP= ''
...
Blockly.MIXLY_4DIGITDISPLAY= '4 Digit Display';
...
Blockly.MIXLY_4DIGITDISPLAY_TM1637_DISPLAYTIME= 'TM1637 Display Time';
...
Blockly.MIXLY_AipFace_match= 'Face comparison';
Blockly.MIXLY_AipFace_match_TOOLTIP= '';
...
Blockly.MIXLY_ESP32_DISPLAY_ANIMATE= "Inner picture";
Blockly.MIXLY_ESP32_INOUT_ANALOG_ATTEN_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_ANALOG_READ_INIT_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_ANALOG_READ_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_ANALOG_WRITE_INIT_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_ANALOG_WRITE_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_PIN_ATTACHINTERRUPT_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_PIN_PRESSED_INIT_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_PIN_PRESSED_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_PWM_ANALOG_WRITE_INIT_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_PWM_ANALOG_WRITE_SET_FREQ_TOOLTIP= "";
Blockly.MIXLY_ESP32_INOUT_PWM_ANALOG_WRITE_TOOLTIP= "";
Blockly.MIXLY_ESP32_RTC_GET_TIME_TOOLTIP= "";
Blockly.MIXLY_ESP32_SCROLL_IMAGE_OR_STRING_DELAY= "";
Blockly.MIXLY_ESP32_SENSOR_MIXGO_PIN_NEAR_TOOLTIP= ''
Blockly.MIXLY_ESP32_SENSOR_USE_I2C_TOOLTIP= ''
Blockly.MIXLY_ESP32_SERVO_MOVE= 'Set Servo (0~180°)';
Blockly.MIXLY_ESP32_SHOW_IMAGE_OR_STRING_DELAY= "Show Image or String";
Blockly.MIXLY_ESP32_SPI_INIT_TOOLTIP= "";
...
Blockly.MIXLY_MICROBIT_SENSOR_DS18X20_TOOLTIP= '' ;
Blockly.MIXLY_MICROBIT_SENSOR_SHT_HUM_TOOLTIP= '';
Blockly.MIXLY_MICROBIT_SENSOR_SHT_temperature_TOOLTIP= "";
Blockly.MIXLY_MILLISECOND= 'ms';
Blockly.MIXLY_MINUTE= 'minute';
Blockly.MIXLY_MONTH= 'month';
Blockly.MIXLY_OLED_LINE= "Draw lines with set vertices and lengths";
Blockly.MIXLY_OLED_LINE_ARBIT= "Draw lines at the set start and end points";
Blockly.MIXLY_OLED_RECT= "Draw a rectangle with the set vertices and length";
Blockly.MIXLY_PYTHON_CONTROLS_FOR_RANGE_TOOLTIP= "";
Blockly.MIXLY_PYTHON_INOUT_PRINT_END_TOOLTIP= "";
Blockly.MIXLY_PYTHON_LISTS_ZIP= "Package iterator";
Blockly.MIXLY_PYTHON_LISTS_ZIP_ITEM= "Iterator";
Blockly.MIXLY_PYTHON_LISTS_ZIP_ITEM_TOOLTIP= '';
Blockly.MIXLY_PYTHON_LISTS_ZIP_TOOLTIP= "";
Blockly.MIXLY_PYTHON_LOGIC_COMPARE_CONTINOUS_TOOLTIP= "";
Blockly.MIXLY_PYTHON_LOGIC_IS_TOOLTIP= "";
Blockly.MIXLY_PYTHON_MATH_CONSTANT= "constant";
Blockly.MIXLY_PYTHON_MATH_CONSTANT_E_TOOLTIP= "";
Blockly.MIXLY_PYTHON_MATH_CONSTANT_PI_TOOLTIP= "";
Blockly.MIXLY_RGB= 'RGB';
Blockly.MIXLY_RGB_B= 'B';
Blockly.MIXLY_RGB_COUNT= 'number of RGB';
...
Blockly.MIXLY_TOOLTIP_RFID_OFF= 'Make RFID devices no longer read data';
...
Blockly.Msg.DS_ADD_NODE= "Insert node";
...
Blockly.Msg.DS_ADD_NODE_TOOLTIP= "";
Blockly.Msg.DS_CREATE_LINKEDLIST_ATTRIBUTE= "Built-in properties and corresponding values";
Blockly.Msg.DS_CREATE_LINKEDLIST_CONTAINER_TITLE= "Linked list node";
...
Blockly.Msg.DS_CREATE_LINKEDLIST_TOOLTIP= "";
Blockly.Msg.DS_CREATE_LINKEDLIST_TYPE= "Node Type  ";
Blockly.Msg.DS_CREATE_NODE_NEW= "Create new node";
Blockly.Msg.DS_CREATE_NODE_TOOLTIP= "";
Blockly.Msg.DS_CREATE_NODE_USE= "Use an existing node type";
Blockly.Msg.DS_DEL_NODE_ATTR= "Delete attribute";
Blockly.Msg.DS_DEL_NODE_NAME= "Delete node";
Blockly.Msg.DS_DEL_NODE_TOOLTIP= "";
Blockly.Msg.DS_GET_NODE_ATTR_NODE= "Get node";
Blockly.Msg.DS_GET_NODE_ATTR_TOOLTIP= "";
...
Blockly.Msg.DS_SET_NODE_ATTR_TOOLTIP= "";
...
Blockly.Msg.MIXPY_AI_AUDIO_TIME= "Recording duration (s)";
Blockly.Msg.MIXPY_AI_AUDIO_TOOLTIP= "";
Blockly.Msg.MIXPY_AI_PHOTO= "Take a photo with camera,File name";
Blockly.Msg.MIXPY_AI_PHOTO_BUTTON= "Shooting button";
Blockly.Msg.MIXPY_AI_PHOTO_TOOLTIP= "";
Blockly.Msg.MIXPY_AI_RESULT= "Get results";
Blockly.Msg.MIXPY_SERIAL_CLOSE= "Close the serial port";
Blockly.Msg.MIXPY_SERIAL_CLOSE_TOOLTIP= "";
Blockly.Msg.MIXPY_SERIAL_OPEN= "Open the available serial port";
Blockly.Msg.MIXPY_SERIAL_OPEN_TIMEOUT= "Read wait time (s)";
Blockly.Msg.MIXPY_SERIAL_OPEN_TOOLTIP= "";
Blockly.Blynk_connecte_state="blynk Connect State";
Blockly.Msg.MIXPY_SERIAL_READ= "Serial port read data length";
Blockly.Msg.MIXPY_SERIAL_READ_TOOLTIP= "";
Blockly.Msg.MIXPY_SERIAL_WRITE= "Serial Write";
Blockly.Msg.MIXPY_SERIAL_WRITE_TOOLTIP= "";
...
Blockly.MIXLY_Keypad_EVENT='Matrix keyboard Event';
...
Blockly.MIXLY_U8G2_SETCONTRAST="OLED backlight";
Blockly.MIXLY_U8G2_SETCONTRAST_HELP="OLED backlight brightness range (0-255)";
Blockly.MIXPY_PANDAS_READ_CSV ="Read CSV file;";
// Blockly.MIXLY_MICROBIT_Scroll_string ="Scrolling string% 1 delay% 2 ms% 3 wait% 4% 5 cycles% 6% 7 clear% 8;";
...
Blockly.MIXLY_TURTEL_GETSCREEN ="initialize turtle screen;";
Blockly.MIXLY_TURTEL_GETSCREEN_TOOLTIP ="initialize the turtle screen, allow screen adjustments or create screen events;";
Blockly.MIXLY_TURTEL_EVENT_ONKEY ="create event press key;";
Blockly.MIXLY_TURTEL_EVENT_ONKEY_TOOLTIP ="Create a keyboard response event. The string key value can be a normal key or a function key. A key value of none means that any key press will trigger ;";
...
Blockly.MIXLY_TURTEL_EVENT_ONTIMER_TOOLTIP ="create a countdown event, and the specified countdown time triggers the corresponding function;";
...
Blockly.mixpy_PYLAB_PIE ="draw pie chart;";
Blockly.mixpy_PYLAB_BAR_ALIGN ="alignment;";
Blockly.mixpy_PYLAB_PLOT_X ="independent variable;";
...
Blockly.mixpy_PL_SAVEFIG ="Save the drawing as a picture;";
Blockly.mixpy_PL_SAVEFIG_TOOLTIP="Save the drawn drawing. Parameters can set the path, name and extension of the saved picture";
Blockly.mixpy_TURTLE_SAVEFIG_TOOLTIP="Save the drawing through the turtle screen. The supported file format is. EPS. You need to initialize the turtle screen in advance";
...
Blockly.mixpy_PYLAB_PIE_AUTOPCT_T ="keep two decimal places;";
Blockly.MIXLY_PYTHON_TEXT_EVAL ="get string;";
Blockly.MIXLY_PYTHON_TEXT_EVAL_RESULT ="execution result;";
Blockly.MIXLY_PYTHON_TEXT_EVAL_TOOLTIP ="get the return value of parameter code execution, and return none if there is no return value of parameter code;";
