...
Blockly.LKL_NOVA_TiltSwitch_UP='傾斜';
Blockly.LKL_NOVA_TiltSwitch_DOWN='水平';
Blockly.LKL_NOVA_SOUND = '聲音'; 
...
Blockly.LKL_NOVA_SERVO = '小舵機';
Blockly.LKL_NOVA_SERVO_BIG = '大舵機驅動';
Blockly.LKL_NOVA_SERVO_BRANCH = '分支分支';
...
Blockly.LKL_NOVA_READ = '獲取灰度狀態';

Blockly.LKL_NOVA_4DIGITDISPLAY = '數碼管';
Blockly.LKL_NOVA_NUMBER = '數字';
Blockly.LKL_NOVA_TIME = '時間';
Blockly.LKL_NOVA_DISPLAY_NUMBER = '數值';
Blockly.LKL_NOVA_DISPLAY_CLEAR= '清空第幾位(1/2/3/4)';
...
Blockly.LKL_NOVA_RTC_SET_SEC = '設置秒(0~59)';
Blockly.LKL_NOVA_RTC_SET_MIN = '設置分(0~59)';
Blockly.LKL_NOVA_RTC_SET_HOUR = '設置時(0~23)';
Blockly.LKL_NOVA_RTC_SET_WEEK = '設置星期(1~7)';
Blockly.LKL_NOVA_RTC_SET_DAY = '設置日';
Blockly.LKL_NOVA_RTC_SET_MON = '設置月';
Blockly.LKL_NOVA_RTC_SET_YEAR = '設置年(>2000)';

Blockly.LKL_NOVA_IR_REC = '紅外鍵值';
Blockly.LKL_NOVA_IR_REC_AVAILABLE = '紅外接收有信號';
...
Blockly.LKL_NOVA_Vibration_Vibrating='有震動';
Blockly.LKL_NOVA_Vibration_NoVibrating='無震動';
...
Blockly.LKL_NOVA_STEPPER_RUN='步進電機執行動作';
...
Blockly.LKL_NOVA_MP3_PAUSE='暫停';
Blockly.LKL_NOVA_MP3_STOP='停止';

Blockly.LKL_NOVA_GYRO='陀螺儀';
Blockly.LKL_NOVA_GYRO_UPDATE='陀螺儀更新數據';
Blockly.LKL_NOVA_GYRO_STATE='坐標';
Blockly.LKL_NOVA_GYRO_X='X坐標';
Blockly.LKL_NOVA_GYRO_Y='Y坐標';

Blockly.LKL_NOVA_MQ='氣體';

Blockly.LKL_NOVA_DUAL_MOTOR='雙路電機';
...
Blockly.LKL_NOVA_FLAME='火焰';

Blockly.LKL_NOVA_HALL='霍爾開關';
Blockly.LKL_NOVA_Hall_NoMagnetic='無磁';
Blockly.LKL_NOVA_Hall_Magnetic='有磁';

Blockly.LKL_NOVA_ITR='紅外對射開關';
Blockly.LKL_NOVA_ITR_Noshelter='無遮擋';
Blockly.LKL_NOVA_ITR_Shelter='有遮擋';

Blockly.LKL_NOVA_POTENTIOMETER='電位器(0~100)';
