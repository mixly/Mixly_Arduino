...
Blockly.Msg.LISTS_CREATE_EMPTY_TITLE = "初始化为空列表";
...
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "初始化列表为";
...
Blockly.LKL_SERIAL_PRINT_HEX='串口打印（16进制）';
...
Blockly.LANG_LISTS_GET_INDEX_INPUT_IN_LIST = '项（在列表';
...
Blockly.LANG_LISTS_SET_INDEX_INPUT_IN_LIST = '项（在列表';
