...
Blockly.MIXLY_TOOPTIP_4DIGITDISPLAY_TM1637_BRIGHTNESS = '设置TM1637的亮度,范围0-100';
...
Blockly.MIXLY_4DIGITDISPLAY_TM1637_DISPLAYSTRING_TIP = '少于等于4字符为显示，超过4个字符为滚动显示。';
...
Blockly.MIXLY_ESP32_IOT_CONNECT_WIFI = "确保连接到Wi-Fi";
...
Blockly.MIXLY_STM32_OLED_SET_CURSOR_POSITION="光标位置设为";
Blockly.MIXLY_STM32_OLED_TINY="极小";
Blockly.MIXLY_STM32_OLED_SMALL="小";
Blockly.MIXLY_STM32_OLED_BIG="大";
Blockly.MIXLY_STM32_OLED_HUGE="极大";
Blockly.MIXLY_STM32_OLED_SET_FONT_COLOR="设置字体颜色";
Blockly.MIXLY_STM32_OLED_BLACK_ON_WHITE="白底黑字";
Blockly.MIXLY_STM32_I2C_SLAVE_SEND_ARRAY="从机发送数组";
Blockly.MIXLY_STM32_I2C_SLAVE_SEND_EVENT="从机发送事件";
Blockly.MIXLY_STM32_I2C_SLAVE_RECEIVE_EVENT="从机接收事件";
Blockly.MIXLY_STM32_I2C_SLAVE_SEND_BYTE="从机发送字节";
Blockly.MIXLY_STM32_SPI_GET_REGISTER_DATA="获取寄存器数据";
Blockly.MIXLY_STM32_SPI_DATA_RECEIVED="接收到数据";
Blockly.MIXLY_GLOBAL_VARIABLE="全局变量";
Blockly.MIXLY_LOCAL_VARIABLE="局部变量";
Blockly.MIXLY_TYPE="类型";
Blockly.MIXLY_volume="容量";
Blockly.MIXLY_SD_LIST_FILES="列出SD根目录文件";
Blockly.MIXLY_SD_clusterCount="簇数";
Blockly.MIXLY_SD_blocksPerCluster="每簇扇区数";
Blockly.MIXLY_SD_TOTAL_blocks="总扇区数";
Blockly.MIXLY_PRINT_INLINE="不换行";
Blockly.MIXLY_STM32_TFT_GREENTAB="绿色标签";
Blockly.MIXLY_STM32_TFT_REDTAB="红色标签";
Blockly.MIXLY_STM32_TFT_BLACKTAB="黑色标签";
Blockly.MIXLY_STM32_TFT_FONT_COLOR="字体颜色";
Blockly.MIXLY_STM32_TFT_BACKGROUND_COLOR="背景颜色";
Blockly.MIXLY_STM32_TFT_BACKGROUND="背景";
Blockly.MIXLY_STM32_TFT_SIZE="尺寸";
Blockly.MIXLY_TOOLTIP_STORE_EEPROM_PUT = '向EEPROM特定地址写入任何类型数据';
Blockly.MIXLY_TOOLTIP_STORE_EEPROM_GET = '从EEPROM的特定地址读取任何类型数据';
Blockly.MIXLY_WIFI_LINK_DEVICE = '链接设备';
Blockly.MIXLY_STM32_SPI_REMAP = '重映射';
Blockly.MIXLY_RFID_READ_CARD_UID = '读取卡号';
...
Blockly.MIXLY_NominalResistance= '常温电阻值';
Blockly.MIXLY_betaCoefficient= 'B值';
Blockly.MIXLY_seriesResistor= '串联电阻值';
Blockly.define_Lists = '创建局部数组为 ';
Blockly.define_Lists2 = '创建全局数组为 ';
Blockly.Hardware_Serial = '硬串口';
Blockly.SOFT_RESET='重启';
Blockly.MIXLY_DIGITAL_PIN = "数字管脚";
Blockly.MIXLY_PUSH_PULL_OUTPUT = "数字输出";
Blockly.MIXLY_OPEN_DRAIN_OUTPUT = "开漏输出";
Blockly.MIXLY_ONEWIRE_WRITE_BIT = "写入比特";
Blockly.MIXLY_ONEWIRE_READ_BIT = "读取比特";
Blockly.MIXLY_I2C_TRY_TO_OCCUPY_THE_BUS = "占用总线";
...
Blockly.MIXLY_EMQX_INIT_CLIENT = '初始化客户端';
Blockly.MIXLY_EMQX_SERVER = '服务器地址';
Blockly.MIXLY_EMQX_PORT = '端口号';
Blockly.MIXLY_EMQX_USERNAME = '用户名';
Blockly.MIXLY_EMQX_PASSWORD = '密码';
Blockly.MIXLY_EMQX_CLIENT_ID = '客户端ID';
Blockly.MIXLY_EMQX_IS_SSL = '是否SSL';
Blockly.MIXLY_EMQX_SOCKET_POOL = '连接池';
Blockly.MIXLY_EMQX_SSL_CONTEXT = 'SSL上下文';
Blockly.MIXLY_EMQX_PUBLISH = '发送数据';
Blockly.MIXLY_EMQX_PUBLISH_TOPIC = '主题';
Blockly.MIXLY_EMQX_PUBLISH_MSG = '消息';
Blockly.MIXLY_EMQX_DEINIT = '释放客户端';
Blockly.MIXLY_EMQX_SPECIAL = '特殊';
Blockly.MIXLY_EMQX_SET_METHOD = '设置回调函数';
Blockly.MIXLY_EMQX_REMOVE_METHOD = '清除回调函数';
Blockly.MIXLY_EMQX_FOR = '为';
Blockly.MIXLY_EMQX_SET_USERNAME = '设置用户名';
Blockly.MIXLY_EMQX_SET_PASSWORD = '密码';
Blockly.MIXLY_EMQX_HOST = 'IP地址';
Blockly.MIXLY_EMQX_CONNECT = '连接';
Blockly.MIXLY_EMQX_RECONNECT = '重新连接';
Blockly.MIXLY_EMQX_CONNECT_ON = '启动代理连接';
Blockly.MIXLY_EMQX_CLEAN_SESSION = '持久对话';
Blockly.MIXLY_EMQX_PORT = '端口号';
Blockly.MIXLY_EMQX_KEEP_ALIVE = '最长通信时间';
Blockly.MIXLY_EMQX_DISCONNECT = '断开连接';
Blockly.MIXLY_EMQX_RETAIN = '返回值';
Blockly.MIXLY_RETAIN = '代理保存';
Blockly.MIXLY_EMQX_QOS =  '服务质量';
...
Blockly.MIXLY_EMQX_UNSUBSCRIBE = '取消订阅';
Blockly.MIXLY_EMQX_LOOP = '循环接收订阅 超时';
Blockly.MIXLY_EMQX_LOOPONE = '秒';
Blockly.MIXLY_EMQX_IS_CONNECT = '是否连接成功';
Blockly.MIXLY_EMQX_NABLE_LOGGER = '启用日志';
Blockly.MIXLY_EMQX_NABLE_LOGGERONE = '级别';
Blockly.MIXLY_EMQX_DISABLE_LOGGER = '禁用日志';
Blockly.MIXLY_EMQX_PING = '服务端响应情况';
Blockly.MIXLY_EMQX_PROJECT = '项目';