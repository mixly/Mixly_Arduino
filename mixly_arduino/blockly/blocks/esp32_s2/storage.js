...
Blockly.Blocks['storage_file_write'] = {
 ...
 Blockly.Blocks['storage_delete_file'] = {
   init: function() {
     this.setColour(Blockly.Blocks.storage.HUE);
     this.appendDummyInput()
         .appendField(new Blockly.FieldDropdown([[Blockly.MIXLY_MICROBIT_PY_STORAGE_DELETE_FILE,'remove'],[Blockly.MIXLY_MICROBIT_PY_STORAGE_DELETE_DIRS,'rmdir']]),'MODE');
     this.appendValueInput("FILE")
         .setCheck(String);
     this.setInputsInline(true);
     this.setPreviousStatement(true);
 ...
 Blockly.Blocks['storage_make_dir'] = {
   init: function() {
     ...
     this.appendDummyInput()
         .appendField(Blockly.MIXLY_ESP32_SET+" "+Blockly.MIXLY_MICROBIT_PY_STORAGE_MKDIR);
     this.setInputsInline(true);
     this.setPreviousStatement(true); //in front of the block has something
     this.setNextStatement(true);  //beyond the ... has something
     this.setOutput(false);
     this.setTooltip(Blockly.MIXLY_MICROBIT_PY_STORAGE_MKDIR);
   }
 };
...
Blockly.Blocks['storage_file_status'] = {
   init: function() {
     this.setColour(Blockly.Blocks.storage.HUE);
     this.appendValueInput("FILE")
         .setCheck(String)
         .appendField(Blockly.MIXLY_GET+" "+Blockly.MIXLY_PULSEIN_STAT+"("+Blockly.Msg.HTML_FILE+" "+Blockly.Msg.LOGIC_OPERATION_OR+" "+Blockly.MIXLY_MICROBIT_PY_STORAGE_IS_DIR+") "+Blockly.MIXLY_MICROBIT_PY_STORAGE_THE_PATH);
     this.setInputsInline(true);
     this.setPreviousStatement(false);
     this.setNextStatement(false);
     this.setOutput(true,Boolean);
