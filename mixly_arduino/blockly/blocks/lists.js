...
Blockly.Blocks['lists_create_with'] = {
  ...
  init: function() {
	...
	this.appendDummyInput("")
        .appendField(new Blockly.FieldDropdown([[Blockly.LANG_MATH_INT, 'long'],[Blockly.LANG_MATH_FLOAT, 'float'],[Blockly.LANG_MATH_CHAR, 'char'],[Blockly.LANG_MATH_BYTE, 'unsigned char']]), "TYPE")
        .appendField(' ')
