...
Blockly.Blocks.HT16K33_Init = {
  init: function() {
    ...
    this.appendDummyInput("").appendField(Blockly.MIXLY_MATRIX_NAME).appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName');
...
Blockly.Blocks.MAX7219_init = {
  init: function() {
   this.appendDummyInput("").appendField(Blockly.MIXLY_MAX7219_INIT);
   this.appendDummyInput("").appendField(Blockly.MIXLY_MATRIX_NAME).appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName');
   this.appendValueInput("PIN1").setCheck(Number).setAlign(Blockly.ALIGN_RIGHT).appendField("DIN(MOSI)").appendField(Blockly.MIXLY_PIN);
...
Blockly.Blocks.display_Matrix_DrawPixel = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);
    this.appendDummyInput("").appendField(Blockly.MIXLY_MATRIX_TYPE).appendField(new Blockly.FieldDropdown([['HT16K33','HT16K33'],['MAX7219','MAX7219']]),'TYPE');
    this.appendDummyInput("").appendField(Blockly.MIXLY_MATRIX_NAME).appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName');
...
Blockly.Blocks.display_Matrix_TEXT={
  init:function(){
    ...
    this.appendDummyInput("").appendField(Blockly.MIXLY_MATRIX_TYPE).appendField(new Blockly.FieldDropdown([['HT16K33','HT16K33'],['MAX7219','MAX7219']]),'TYPE');
    this.appendDummyInput("").appendField(Blockly.MIXLY_MATRIX_NAME).appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName');
    this.appendValueInput("TEXT", String).setCheck([Number, String]).setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.texttodisplay);
...
Blockly.Blocks.display_Matrix_fillScreen = {
  init: function() {
    this.setColour(Blockly.Blocks.display.HUE);  
    this.appendDummyInput("").appendField(Blockly.MIXLY_MATRIX_TYPE).appendField(new Blockly.FieldDropdown([['HT16K33','HT16K33'],['MAX7219','MAX7219']]),'TYPE');
    this.appendDummyInput("").appendField(Blockly.MIXLY_MATRIX_NAME).appendField(new Blockly.FieldTextInput('myMatrix'), 'matrixName').appendField(Blockly.MIXLY_STAT); 
    this.appendDummyInput("").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldDropdown(MAX7219_FILLSCREEN_SELECT), "FILLSCREEN_TYPE");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
