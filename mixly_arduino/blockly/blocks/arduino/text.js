...
Blockly.Blocks['text_equals_starts_ends']={
  init: function() {
   ...
   this.setTooltip(function(){
    ...
    return Blockly.MIXLY_TOOLTIP_TEXT_EQUALS_STARTS_ENDS.replace('%1',TOOLTIPS[op])
    .replace('%2',Blockly.Arduino.valueToCode(self, 'STR2',Blockly.Arduino.ORDER_ATOMIC));
  });
 }
}
