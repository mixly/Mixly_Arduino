/*
ESP32SoftwareSerial.h

ESP32SoftwareSerial.cpp - Implementation of the Arduino software serial for ESP8266.
...
class ESP32SoftwareSerial : public Stream
{
  public:
    ESP32SoftwareSerial(int receivePin, int transmitPin, bool inverse_logic = false, unsigned int buffSize = 64);
    ~ESP32SoftwareSerial();
