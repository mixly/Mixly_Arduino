...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>配置 WiFi</button></form><br/><form action=\"/0wifi\" method=\"get\"><button>配置 WiFi (手动设置)</button></form><br/><form action=\"/i\" method=\"get\"><button>硬件信息</button></form><br/><form action=\"/r\" method=\"post\"><button>重置</button></form>";
...
const char HTTP_SAVED[] PROGMEM           = "<div>信息已保存<br />正在连接到网络...<br />如果连接失败，请重试！</div>";
