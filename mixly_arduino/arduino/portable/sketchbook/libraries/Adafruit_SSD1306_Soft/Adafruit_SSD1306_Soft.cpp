/*!
 * @file Adafruit_SSD1306_Soft.cpp
 *
...
/*!
    ...
    @return Adafruit_SSD1306_Soft object.
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Adafruit_SSD1306_Soft::Adafruit_SSD1306_Soft(uint8_t w, uint8_t h, SoftwareWire *twi,
...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Adafruit_SSD1306_Soft::Adafruit_SSD1306_Soft(uint8_t w, uint8_t h,
...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Adafruit_SSD1306_Soft::Adafruit_SSD1306_Soft(uint8_t w, uint8_t h, SPIClass *spi,
...
/*!
    @brief  DEPRECATED constructor for SPI SSD1306 displays, using software
            ...
            one of the SSD1306_* size defines in Adafruit_SSD1306_Soft.h. New
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Adafruit_SSD1306_Soft::Adafruit_SSD1306_Soft(int8_t mosi_pin, int8_t sclk_pin,
...
/*!
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Adafruit_SSD1306_Soft::Adafruit_SSD1306_Soft(int8_t dc_pin, int8_t rst_pin,
...
/*!
    @brief  DEPRECATED constructor for I2C SSD1306 displays. Provided for
            ...
            defines in Adafruit_SSD1306_Soft.h. New code should NOT use this.
    ...
    @note   Call the object's begin() function before use -- buffer
            allocation is performed there!
*/
Adafruit_SSD1306_Soft::Adafruit_SSD1306_Soft(int8_t rst_pin) :
...
/*!
    @brief  Destructor for Adafruit_SSD1306_Soft object.
*/
Adafruit_SSD1306_Soft::~Adafruit_SSD1306_Soft(void) {
  if(buffer) {
    free(buffer);
    buffer = NULL;
  }
...
inline void Adafruit_SSD1306_Soft::SPIwrite(uint8_t d) {
  if(spi) {
    (void)spi->transfer(d);
  } else {
...
void Adafruit_SSD1306_Soft::ssd1306_command1(uint8_t c) {
  if(wire) { // I2C
...
void Adafruit_SSD1306_Soft::ssd1306_commandList(const uint8_t *c, uint8_t n) {
  if(wire) { // I2C
    wire->beginTransmission(i2caddr);
    WIRE_WRITE((uint8_t)0x00); // Co = 0, D/C = 0
    uint8_t bytesOut = 1;
...
/*!
    ...
    @return None (void).
*/
void Adafruit_SSD1306_Soft::ssd1306_command(uint8_t c) {
  TRANSACTION_START
  ssd1306_command1(c);
  TRANSACTION_END
}
...
*/
boolean Adafruit_SSD1306_Soft::begin(uint8_t vcs, uint8_t addr, boolean reset,
  boolean periphBegin) {
...
*/
void Adafruit_SSD1306_Soft::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
/*!
    ...
    @note   Changes buffer contents only, no immediate effect on display.
            ...
            commands as needed by one's own application.
*/
void Adafruit_SSD1306_Soft::clearDisplay(void) {
...
/*!
    ...
    @note   Changes buffer contents only, no immediate effect on display.
            ...
            commands as needed by one's own application.
*/
void Adafruit_SSD1306_Soft::drawFastHLine(
...
void Adafruit_SSD1306_Soft::drawFastHLineInternal(
  int16_t x, int16_t y, int16_t w, uint16_t color) {
...
/*!
    ...
    @note   Changes buffer contents only, no immediate effect on display.
            ...
            commands as needed by one's own application.
*/
void Adafruit_SSD1306_Soft::drawFastVLine(
...
void Adafruit_SSD1306_Soft::drawFastVLineInternal(
...
*/
boolean Adafruit_SSD1306_Soft::getPixel(int16_t x, int16_t y) {
  if((x >= 0) && (x < width()) && (y >= 0) && (y < height())) {
    // Pixel is in-bounds. Rotate coordinates if needed.
    switch(getRotation()) {
     case 1:
...
*/
uint8_t *Adafruit_SSD1306_Soft::getBuffer(void) {
  return buffer;
}
...
*/
void Adafruit_SSD1306_Soft::display(void) {
  TRANSACTION_START
...
void Adafruit_SSD1306_Soft::startscrollright(uint8_t start, uint8_t stop) {
  TRANSACTION_START
...
void Adafruit_SSD1306_Soft::startscrollleft(uint8_t start, uint8_t stop) {
  TRANSACTION_START
...
void Adafruit_SSD1306_Soft::startscrolldiagright(uint8_t start, uint8_t stop) {
  TRANSACTION_START
...
void Adafruit_SSD1306_Soft::startscrolldiagleft(uint8_t start, uint8_t stop) {
  TRANSACTION_START
...
/*!
    ...
    @return None (void).
*/
void Adafruit_SSD1306_Soft::stopscroll(void) {
  TRANSACTION_START
...
*/
void Adafruit_SSD1306_Soft::invertDisplay(boolean i) {
  TRANSACTION_START
...
*/
void Adafruit_SSD1306_Soft::dim(boolean dim) {
  uint8_t contrast;
